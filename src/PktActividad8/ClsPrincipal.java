...
public class ClsPrincipal {
	...
	public static void main(String[] args) {
		...
		//Arreglo del vector
		ClsCalculo arrObj[]= new ClsCalculo[2];
		//Llamado de Promedio
		...
		for(i=0;i<arrObj.length;i++) {
			...
			Parcial1=Integer.parseInt(JOptionPane.showInputDialog("Ingresa la nota del parcial 1"));
			Parcial2=Integer.parseInt(JOptionPane.showInputDialog("Ingresa la nota del parcial 2"));
			Parcial3=Integer.parseInt(JOptionPane.showInputDialog("Ingresa la nota del parcial 3"));
			Labo1=Integer.parseInt(JOptionPane.showInputDialog("Ingresa la nota del laboratorio 1"));
			Labo2=Integer.parseInt(JOptionPane.showInputDialog("Ingresa la nota del laboratorio 2"));
			Labo3=Integer.parseInt(JOptionPane.showInputDialog("Ingresa la nota del laboratorio 3"));
			Semestral=Integer.parseInt(JOptionPane.showInputDialog("Ingresa la nota del semestral"));
